...
def main():
    ...
    token = google_auth("raul_dfa")
    config = json.loads(download_fromStorage(file_key = "google/raul_examplereportpuller.json", bucket_name = "xax-configs", client = client, string = True))
