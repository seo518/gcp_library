...
def main():
    ...
    token = google_auth("miguel_dfa")
    config = json.loads(download_fromStorage(file_key = "google/google_Volvo_GRS_report_puller_config.json", bucket_name = "xax-configs", client = client, string = True))
