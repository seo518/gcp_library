...
def main():
    ...
    token = google_auth("shweta_dfa")
    config = json.loads(download_fromStorage(file_key = "google/WMWV_report_puller_config.json", bucket_name = "xax-configs", client = client, string = True))
