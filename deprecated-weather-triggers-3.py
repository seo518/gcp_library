...
def main():
    ...
    output_file = f'{dtime_max - dtime_min}hours_{T_min}-{T_max}-3.csv'
    ...
    if f:
        ...
        skiprows = range(1, 2 * rows_per_cloudfunction_except_last + 1)
        nrows = rows_per_cloudfunction_last
        ...
        file_name = '/tmp/' + f'{dtime_max - dtime_min}hours_{T_min}-{T_max}-3.csv'
