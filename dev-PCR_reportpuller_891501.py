...
def main():
    ...
    token = google_auth("b3themig_dfa")
    config = json.loads(download_fromStorage(file_key = "google/google_raul_reportpuller-891501.json", bucket_name = "xax-configs", client = client, string = True))
